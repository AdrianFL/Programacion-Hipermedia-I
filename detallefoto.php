...
?>
		<?php
		// obtenre el id por el get_browser
		// decidir si par o impar 
		// si par, pinto foto par
		// sino pinto foto impar
		?>
		<main>
			<article class="detfoto">
				...
				Fecha: <time datetime="2700-12-28"> 28 de diciembre de 2700</time><br>
				País: Ryleg<br>
